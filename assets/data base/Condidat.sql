...
UPDATE Opale.employers set image='employeprofil.png' where id=id;
...
insert into Opale.RHinfo (nom,matricule,passwrd) values ('Said Skhiri','OPL-12534','RHpasswordSaid'); /* l'ID='OPL-12534' et le mot de passe = 'RHpasswordSaid'*/
