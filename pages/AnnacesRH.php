...
<head>
    ...
    <link rel="stylesheet" href="./AnnacesRH.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    
    <title>Les annaces</title>
    <style>
        ...
        #supprimer{
            background-color:#344F1F; border:0px; border-radius:2rem;
            color:white;
        }
        body{
            min-width:765px;
                    ...
                    <a href="#" id="employeers" class="a" title="Employees"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
                      ...
                      <?php
                         echo '<ul class="ul">
                              ...
                              <li class="li2"><a href="http://localhost/Opale/pages/AjouterEmployers.php?&matricule='.$matricule.'" class="a">Ajouter des employés</a></li>
            ...
            <div class="annaces">
                <div class="annavespartie">
                        ...
                        echo '<div class="annance">
                            <h4 style="color:#3B6064;">'.$titre.'</h4>
                            <h6 style="text-align:justify;">'.$contenu.'</h6>
                            <form action="supprimerann.php?id='.$row['id'].'&matricule='.$matricule.'" method="post">
                            <input type="submit" name="supprimer" id="supprimer" value="suppimer">
                            </form>
                        </div>';
                        $num = $num-1;
                        }
                ...
                <div class="addannaces">
                    <?php 
                   echo '<form action="addannance.php?&matricule='.$matricule.'" method="post">';
                  ?>
                        <div>
                        <label for=""><h5> Ajouter une nouvelle annance : </h5></label> <br />
                        <input type="textarea" name="titre" id="titre" placeholder="Le titre">
                        </div>
                        <div class="textarea">
                        <textarea name="contenu" id="contenu" cols="51" rows="10" placeholder="L'annance"></textarea>
                        </div>
                        <div class="submit">
                        <input type="submit" id="annancer" name="annancer" value="annancer">
                        </div>
                    </form>
                </div>
            </div>
